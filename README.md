...
<p >
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=nextjs,nestjs,prisma,tailwind,ts,java,git,unity,cs,flutter,dart,aws,azure,bash,bootstrap,c,css,docker,express,figma,firebase,github,html,idea,js,flutter,linux,materialui,mongodb,mysql,nodejs,postman,py,react,redux,blender&perline=20" />
  </a>
</p>
